    ...
    <div className=" flex flex-col gap-y-4">
      <Tabs defaultValue="summary">
        <div className=" bg-white rounded-lg border px-3">
          <ScrollArea>
            <TabsList className=" p-0 bg-background justify-start rounded-none h-13">
              <TabsTrigger
                value="summary"
                className="text-muted-foreground rouneded-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:border-b-primary data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
              >
                <BookOpenTextIcon />
                Summary
              </TabsTrigger>
        ...
        <TabsContent value="recording">
          <div className=" bg-white rouneded-lg border px-4 py-5">
            <video
        ...
        <TabsContent value="summary">
          <div className=" bg-white rouneded-lg border">
              ...
              <div>
                <Markdown
                  components={{
                    ...
                    h4: (props) => (
                      <h4 className="text-base font-medium mb-4" {...props} />
                    ),
                    p: (props) => (
